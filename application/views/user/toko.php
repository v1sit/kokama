            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div> 
                        ...
                        <h1> <img src="uploads/toko.jpg" width="80" height="65" title="Logo of a company" alt="Logo of a company" /> </h1>
                        <!-- <h1 class="h3 mb-4 text-gray-800">Toko Pak Edi</h1> -->
                    </div>
                        ...
                        <div class="row text-center">
                            ...
                            <?php foreach ($barang as $brg): ?>
                                ...
                                <div class="card ml-5" style="width: 16rem;">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title mb-1"><?= $brg->namaBrg ?> </h5>
                                        <small> <?= $brg->keterangan?> </small> <br>
                                        <span class="badge badge-pill badge-success mb-2"> Rp. <?= $brg->harga?> </span> <br>
                                         <?= anchor('toko/tambah_ke_keranjang/'.$brg->idBarang,'<div class="btn btn-sm btn-primary active"> <i class="fa fa-cart-plus" > </i> tambah ke keranjang </div>')?>
